...
export const COMMON_PHRASES_MAP: Record<string, Record<string, string>> = {
  ...
  'i am looking forward to seeing you': {
    ...
    Indonesian: 'Saya sangat menantikan untuk bertemu denganmu!',
    ...
    Oromo: 'Sii arguuf hawwii guddaan qaba!'
  },
  'i am fine': {
    Spanish: 'Estoy bien',
  ...
  'she is very good at learning new languages': {
    ...
    Hindi: 'वह नई भाषाएँ सीखने में बहुत अच्छी है।',
    Mandarin: '她非常擅长学习新语言。',
    Japanese: '彼女は新しい言語を学ぶのがとても得意です。',
    Korean: '그녀는 새로운 언어를 배우는 데 매우 뛰어납니다.',
    Arabic: 'إنها بارعة جداً في تعلم لغات جديدة.',
    Vietnamese: 'Cô ấy học ngoại ngữ mới rất giỏi.',
    Tagalog: 'Napakagaling niya sa pag-aaral ng mga bagong wika.',
    Italian: 'È bravissima a imparare nuove lingue.',
    Russian: 'Она очень способна к изучению новых языков.',
    Turkish: 'Yeni diller öğrenmede çok başarılıdır.',
    Polish: 'Ona bardzo dobrze uczy się nowych języków.',
    ...
    Oromo: 'Afaanota haaraa barachuu irratti baay\'ee ciccooftuudha.'
  },
  'could you please turn on the lights': {
    Spanish: '¿Podrías encender las luces, por favor?',
    Portuguese: 'Você poderia acender as luzes, por favor?',
    French: 'Pourriez-vous allumer les lumières, s\'il vous plaît ?',
    German: 'Könntest du bitte das Licht anmachen?',
    Hindi: 'क्या आप कृपया बत्तियां जला सकते हैं?',
    Mandarin: '请打开灯好吗？',
    Japanese: '電気をつけていただけますか？',
    Korean: '불 좀 켜 주시겠어요?',
    Arabic: 'هل يمكنك إشعال الأنوار من فضلك؟',
    Vietnamese: 'Làm ơn bật đèn lên được không?',
    Tagalog: 'Maaari mo bang buksan ang ilaw, pakiusap?',
    Italian: 'Potresti accendere le luci, per favore?',
    Russian: 'Не могли бы вы включить свет, пожалуйста?',
    Turkish: 'Lütfen ışıkları açabilir misiniz?',
    Polish: 'Czy mógłbyś włączyć światła, proszę?',
    Indonesian: 'Bisakah Anda tolong menyalakan lampunya?',
    Swahili: 'Je, unaweza kuwasha taa tafadhali?',
    Yoruba: 'Ṣe o le tan imọlẹ jọ̀wọ́?',
    Igbo: 'Biko ị nwere ike ịgbanye ọkụ?',
    Hausa: 'Za ka iya kunna fitilu don Allah?',
    Amharic: 'እባክዎን መብራቶቹን ማብራት ይችላሉ?',
    Zulu: 'Ungacela ukukhanyisa izibani?',
    Xhosa: 'Ungacela ukulilayita ilahla?',
    Afrikaans: 'Kan jy asseblief die ligte aanskakel?',
    Somali: 'Fadlan ma shidi kartaa laydhadhka?',
    Oromo: 'Ibsaa nuuf ibsuu dandeessaa mee?'
  },
  'i agree completely with your idea': {
    ...
    Mandarin: '我完全同意你的想法。',
    Japanese: 'あなたの考えに完全に賛成です。',
    Korean: '당신의 생각에 전적으로 동의합니다.',
    Arabic: 'أنا متفق تماماً مع فكرتك.',
    Vietnamese: 'Tôi hoàn toàn đồng ý với ý tưởng của bạn.',
    Tagalog: 'Ganap akong sumasang-ayon sa iyong ideya.',
    ...
    Amharic: 'ከሃसाብዎ ጋር ሙሉ በሙሉ እስማማለሁ።',
    ...
    Oromo: 'Yaada kee guutummaatti nan deeggara.'
  },
  'she has been studying english for three months': {
    ...
    Hindi: 'वह तीन महीने से अंग्रेजी सीख रही है।',
    Mandarin: '她已经学了三个月的英语了。',
    Japanese: '彼女は3ヶ月間英語を勉強しています。',
    Korean: '그녀는 3달 동안 영어를 공부해 왔습니다.',
    Arabic: 'إنها تدرس اللغة الإنجليزية منذ ثلاثة أشهر.',
    Vietnamese: 'Cô ấy đã học tiếng Anh được ba tháng rồi.',
    ...
    Indonesian: 'Dia sudah belajar bahasa Inggris selama tiga bulan.',
    ...
    Oromo: 'Ji\'oottan sadan darbaniif afaan Ingiliffaa barachaa turte.'
  },
  'i am sorry': {
    Spanish: 'Lo siento',
