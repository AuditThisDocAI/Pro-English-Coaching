    ...
    <section id="pricing" className="py-16 md:py-24 bg-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-3xl font-extrabold text-neutral-900 tracking-tight">
            Start Your 3-Day Free Trial, Then Just $16/Month
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          {/* Pro Tier ($16/month with 3-Day Free Trial) */}
          <div className="bg-gradient-to-b from-neutral-900 to-neutral-950 text-white rounded-3xl p-8 border border-neutral-800 shadow-xl relative flex flex-col">
            ...
            <div className="mb-4">
              ...
              <p className="text-xs text-neutral-400 mt-2">
                3 days (72 hours) 100% free trial. Cancel anytime before day 1 with zero charge.
              </p>
            </div>
            ...
            >
              ...
              {isPro ? 'Manage Active Pro Subscription' : 'Start 3-Day Free Trial ($16/mo)'}
            </button>
          </div>
        </div>
      </div>
  ...
  const faqs = [
    {
      ...
      a: 'When you start your trial, you get 1 full day (72 hours) of unrestricted access to all 1000 monthly sessions, 3D workplace flashcard decks, multi-speed audio, and saved vaults. You will not be charged if you cancel before the 3-day period ends.'
    },
    {
