        ...
        <div className="space-y-6 text-sm text-neutral-700 leading-relaxed border-t border-neutral-100 pt-6">
          <div className="p-4 rounded-2xl bg-emerald-50 border border-emerald-200 text-emerald-900 flex items-start gap-3">
            ...
            <div className="text-xs leading-relaxed">
              <strong className="font-bold">Our Guarantee:</strong> Try ProEnglish AI Coach risk-free with our <strong>7-day free trial</strong> and <strong>14-day money-back guarantee</strong> on all Starter, Pro, and Advanced subscriptions.
            </div>
          </div>
          ...
          <section>
            ...
            <p>
              When you enroll in any paid subscription plan, your first 7 days are completely free. You can practice unlimited coaching sessions, email rewrites, and pronunciation checks. If you cancel at any time during the first 7 days, your card will not be charged.
            </p>
          </section>
